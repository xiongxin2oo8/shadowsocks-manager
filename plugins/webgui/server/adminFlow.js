...
exports.getServerUserFlow = (req, res) => {
  ...
  if (Array.isArray(time)) {
    ...
    timeArray.push(moment(time).day(1).hour(0).minute(0).second(0).millisecond(0).toDate().valueOf());
    timeArray.push(moment(time).day(8).hour(0).minute(0).second(0).millisecond(0).toDate().valueOf());
  }
